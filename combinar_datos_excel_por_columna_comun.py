...
df_combined = df_casa_depto[df_casa_depto['Nombre_correspondiente'].notna()]

# Combinar los DataFrames basado en la nueva columna de coincidencias
df_final = pd.merge(df_combined, df_auto_marca, left_on='Nombre_correspondiente', right_on='Nombre', how='inner')

# Guardar el resultado en un nuevo archivo Excel
df_final.to_excel('resultado_combinado2.xlsx', index=False)

print(f"¡Combinación completada y guardada en 'resultado_combinado.xlsx' con {len(df_final)} coincidencias!")
